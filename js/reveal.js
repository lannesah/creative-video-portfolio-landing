...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const revealElements = document.querySelectorAll('.section-heading, .service-card, .work-card, .client-card, .about__text-wrapper');
  ...
  revealElements.forEach((el, index) => {
    ...
    if (el.classList.contains('service-card') || el.classList.contains('client-card')) {
